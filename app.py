...
5. PACING & CHAPTER PROGRESSION: Keep narrative responses concise (2 to 3 paragraphs), but actively stretch out chapters. Do not let the player clear a chapter objective with a single quick action. Introduce minor complications, requiring 3 to 5 meaningful interactions, choices, or skill checks before the 'chapter_complete' flag is ever set to true.
